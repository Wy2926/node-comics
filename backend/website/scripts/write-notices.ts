...
const assets=['src/assets/journey-original.webp','src/assets/journey-translated.webp','src/assets/journey-en.webp','src/assets/journey-ko.webp','src/assets/reading-corner.webp','public/social-cover.webp','src/assets/logo-zh.webp','src/assets/logo-en.webp','public/icon-128.png','public/favicon.ico'];
