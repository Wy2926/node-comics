...
export default {
  "ui": {
    ...
    "firefoxDownloadNote": "Firefox requires a signed extension. The store listing is not available yet.",
  ...
  "account": {
    ...
    "一页，多种语言。": "One page. Many languages.",
    "英文示意": "English",
    "韩文示意": "Korean",
    "正在加载图片…": "Loading image…",
    "图片加载失败": "Image could not load",
    "重新加载": "Retry",
