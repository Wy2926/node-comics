"""Fresh database baseline for reading plans, durable jobs and billing.

This schema intentionally has no upgrade path from older environments.
"""
from alembic import op
import sqlalchemy as sa

revision = "reading_0001"
down_revision = None
branch_labels = None
depends_on = None
...
def upgrade():
    if "users" in sa.inspect(op.get_bind()).get_table_names():
        raise RuntimeError("reading_0001 requires an empty database")
# ### commands auto generated by Alembic - please adjust! ###
    ...
    op.create_index('ix_jobs_content_result', 'jobs', ['cache_key', 'status', 'completed_at'], unique=False)
...
def downgrade():
    raise RuntimeError("Destructive baseline downgrade is unsupported; use an isolated fresh database")
