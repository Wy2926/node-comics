...
# ### commands auto generated by Alembic - please adjust! ###
    ...
    op.create_index('ix_service_heartbeats_heartbeat_at', 'service_heartbeats', ['heartbeat_at'], unique=False)
    ...
    op.create_index('ix_submissions_retention', 'translation_submissions', ['archived_at', 'created_at'], unique=False)
    op.create_table('submission_admissions',
    sa.Column('owner_id', sa.String(length=36), nullable=False),
    sa.Column('request_tokens', sa.Float(), nullable=False),
    sa.Column('item_tokens', sa.Float(), nullable=False),
    sa.Column('refilled_at', sa.DateTime(), nullable=False),
    sa.Column('day_started_at', sa.DateTime(), nullable=False),
    sa.Column('daily_submissions', sa.Integer(), nullable=False),
    sa.Column('daily_items', sa.Integer(), nullable=False),
    ...
    op.create_index('ix_jobs_content_result', 'jobs', ['cache_key', 'status', 'completed_at'])
    op.create_index('ix_assets_content_lookup', 'assets', ['kind', 'sha256'])
    op.create_index('ix_assets_storage_key', 'assets', ['storage_backend', 'storage_key'])
    ...
    op.create_index('ix_text_calls_started_at', 'text_calls', ['started_at'])
