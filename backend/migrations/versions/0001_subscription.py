"""Subscription catalog baseline. Empty databases only; no upgrade path."""
from alembic import op
import sqlalchemy as sa
revision = 'subscription_0001'
down_revision = None
branch_labels = None
depends_on = None
...
def upgrade():
    if set(sa.inspect(op.get_bind()).get_table_names()) - {'alembic_version'}:
        raise RuntimeError('subscription_0001 requires an empty database')
# ### commands auto generated by Alembic - please adjust! ###
    ...
    sa.CheckConstraint("status != 'active' OR (stripe_price_id IS NOT NULL AND stripe_product_id IS NOT NULL)"),
