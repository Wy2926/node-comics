"""Fresh database baseline for shared results, real jobs and reading plans.

No migration or compatibility path from previous databases.
"""
from alembic import op
import sqlalchemy as sa

revision = "results_0001"
down_revision = None
branch_labels = None
depends_on = None
...
def upgrade():
    if "users" in sa.inspect(op.get_bind()).get_table_names():
        raise RuntimeError("results_0001 requires an empty database")
# ### commands auto generated by Alembic - please adjust! ###
    ...
    sa.Column('billing_plus_started_at', sa.DateTime(), nullable=True),
    sa.Column('billing_plus_expires_at', sa.DateTime(), nullable=True),
    sa.Column('billing_membership_id', sa.String(length=64), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    sa.Column('transactions_synced_at', sa.DateTime(), nullable=True),
...
def downgrade():
    raise RuntimeError("Fresh baselines do not support downgrade")
