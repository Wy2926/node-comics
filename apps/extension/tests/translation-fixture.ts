...
export const entitlement=(plus=false):Entitlements=>({plan:plus?'plus':'free',plus_started_at:null,plus_expires_at:null,timezone:'Asia/Shanghai',image_rate_limit:{window_seconds:60,limit:plus?100:30},scheduler_weight:plus?2:1,generated_at:'2026-09-19',pending_previous_period_pages:0,modes:{classic:{allowed:true,unlimited:true,quota_kind:'classic_unlimited',consent_version:'test',quota:null},redraw:{allowed:true,unlimited:true,quota_kind:'redraw_monthly',consent_version:'test',quota:null}}});
