...
export interface Chapter { id: string; title: string; source: string; sourceUrl?: string; createdAt: number; updatedAt: number; lastReadAt?:number; coverPageId?:string; pages: Page[]; pageId: string; relativeOffset: number; demo?: boolean; discoveryComplete?: boolean; }
