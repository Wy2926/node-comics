...
import {ImagePermissionsRequired,requestImagePermissions,imageOrigins} from '../sources';
...
export function BlobPicture({scope,blobKey,job,alt,onShown,onImport,error,sourceUrl,imageUrl}:{scope:string;blobKey?:string;job?:Job;alt:string;onShown?:(image:ShownImage|undefined)=>void;onImport:()=>void;error?:string;sourceUrl?:string;imageUrl?:string}){
