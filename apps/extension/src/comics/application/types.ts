...
export interface LibraryViewModel { works: Work[]; units: ReadingUnit[]; documents: Document[]; positions?: ReadingPosition[]; sourceLabels?:Record<string,string>; nextOffset?: number; }
