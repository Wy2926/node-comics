...
export function settings(): Settings {
  try {
    ...
    const enums={appearance:['system','light','dark'],accentTheme:['sky','rose','mint','iris'],readerBackground:['gray','paper','night'],translationMode:['classic','redraw'],direction:['ltr','rtl'],layout:['continuous','single'],fit:['width','window']} as const;
