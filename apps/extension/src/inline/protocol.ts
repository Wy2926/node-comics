...
export interface InlineRequest {type:'NC_INLINE_TICK'|'NC_INLINE_WAIT'|'NC_INLINE_LEASE'|'NC_INLINE_IMAGE';navigationId:string;generation:number;images:InlineImage[];retryId?:string;resultKey?:string;}
