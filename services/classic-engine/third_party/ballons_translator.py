# Vendored from dmMaze/BallonsTranslator, GPL-3.0.
# Revision: 84ba500ea1a4f523ca79f1c77d8c642eea3d1d07
# Source: ballontranslator/utils/imgproc_utils.py
# Only the two functions below are retained; only trailing whitespace is normalized.
# License: ../licenses/BallonsTranslator-GPL-3.0.txt
import cv2
import numpy as np
