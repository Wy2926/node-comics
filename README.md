...
带漫画阅读器的 Chrome / Edge Manifest V3 浏览器插件。支持本地图片、未加密 MOBI、CBZ/ZIP、CBR/RAR、PDF，以及网页图片采集和原位翻译。
...
| 阅读与翻译 | [阅读计划契约](docs/READING_TRANSLATION_CONTRACT.md)、[网页内翻译](docs/IN_PAGE_TRANSLATION.md)、[语言支持](docs/LANGUAGE_SUPPORT.md)、[译图共享](docs/RESULT_SHARING.md) |
| 漫画管理 | [来源与缓存架构](docs/COMIC_SOURCE_ARCHITECTURE.md)、[新架构实施与验收](docs/COMIC_SOURCE_IMPLEMENTATION.md)、[历史作品模型](docs/COMIC_LIBRARY_DESIGN.md)、[历史管理实现](docs/COMIC_LIBRARY_IMPLEMENTATION.md)、[格式与缓存](docs/IMPORT_FORMATS_AND_CACHE.md)、[漫画导出](docs/COMIC_EXPORT_DESIGN.md) |
