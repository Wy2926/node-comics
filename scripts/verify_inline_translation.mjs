...
const rights={plan:'free',image_rate_limit:{window_seconds:60,limit:30},scheduler_weight:1,timezone:'Asia/Shanghai',plus_started_at:null,plus_expires_at:null,pending_previous_period_pages:0,modes:Object.fromEntries(['classic','redraw'].map(m=>[m,{allowed:true,unlimited:true,quota_kind:m==='classic'?'classic_unlimited':'redraw_grant',consent_version:'fixture',quota:null}]))};
...
const snapshot=()=>({policy_revision:'1',server_time:new Date().toISOString(),entitlements:rights,image_rate_limit:{window_seconds:60,limit:30,remaining:30,retry_after_seconds:0}});
