...
const track=page=>{page.on('pageerror',e=>errors.push(e.message));page.on('request',r=>{if(r.method()==='POST'&&/\/(quotes|translation-batches|translations)\b/.test(r.url()))translationWrites++;});};
